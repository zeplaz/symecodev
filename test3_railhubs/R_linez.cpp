...
R_linez::R_linez(const railhubz& hub_1, const railhubz& hub_2, int& total_R_linez) //(const railhubz& hub1, const railhubz& hub2, int& total_R_linez)
{
